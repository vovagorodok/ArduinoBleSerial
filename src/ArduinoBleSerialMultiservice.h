...
inline BleSerialServerFake* initBle(const std::string& deviceName) {
    return nullptr;
}
inline bool advertiseBle(BleSerialServerFake* server, const std::string& deviceName, const std::string& primaryUUID,
